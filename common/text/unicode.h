...
extern size_t ustrnlen(wchar_t const*, size_t);
...
extern wchar_t* ustrnzcat(wchar_t*, wchar_t const*, size_t);

//extern int ustrncmp(wchar_t const *,wchar_t const *,long);
//extern wchar_t * ustrncpy(wchar_t *,wchar_t const *,long);

extern wchar_t* ustrnzcpy(wchar_t*, wchar_t const*, size_t);
...
extern int usnzprintf(wchar_t*, size_t, wchar_t const*, ...);

//extern int uvfprintf(struct _iobuf *,wchar_t const *,char *);
//extern int uvprintf(wchar_t const *,char *);

extern int uvsnzprintf(wchar_t* string, size_t size, wchar_t const* format, va_list list);
...
{
public:
	explicit c_static_wchar_string() :
		m_string{}
	{
		clear();
	}
	...
	{
		size_t length = csstrnlen(s, k_buffer_size);
		ascii_string_to_wchar_string(s, m_string, &length);
	}
